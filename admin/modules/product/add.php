<?php 
    ...
    if(is_submit("add-product")) {
        ...
        if(empty($name)) {
            $error["username"] = "Bạn chưa nhập tên dự án";
        }
        ...
        if(!($error)) {
            ...
            $error = db_product_add($data); 

            if($error != 1) {
                echo "<script>alert('Thêm dự án thất bại!')</script>";
            } else {
                echo "<script>alert('Tạo dự án thành công!')</script>";
            }
        }
    }
?>
      ...
      <div class="main-sidebar show">
        ...
        <div class="sidebar-content">
          <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            <li class="nav-item">
              <button type="button" class="nav-link accordion-button collapsed collapsed" data-bs-toggle="collapse" data-bs-target="#contact" aria-expanded="false" aria-controls="contact">
            ...
            <li class="nav-item">
              ...
              <ul class="navbar-nav me-auto mb-2 mb-lg-0 accordion-collapse collapse show" id="product" aria-labelledby="headingOne" data-bs-parent=".nav-item">
                ...
                <li class="nav-item">
                  <a href="<?php echo create_link(base_url('admin'), array('m' => 'product', 'a' => 'add')); ?>" class="nav-link check"><i class="fa-regular fa-circle me-2"></i> Thêm dự án</a>
                </li>
              </ul>
            </li>
          </ul>
        ...
        <div class="content-wrapper">
          <div class="container-fluid overflow-scroll bg-secondary bg-opacity-10" style="min-height: calc(100vh - 55px)">
            <div class="row py-3 border-bottom">  
                <div class="col-md-6">
                  <h5 class="ms-3">Thêm dự án hoàn thành</h5>
                </div>
            </div>

            <div class="row bg-white my-3 mx-1 py-3 px-2 rounded-2">
              <div class="col-md-12">
                <form id="form-add-product" class="form-login" method="post" action="<?php echo base_url('admin/?m=product&a=add'); ?>" enctype="multipart/form-data">
                    ...
                    <input type="hidden" name="request_name" value="add-product"/>
