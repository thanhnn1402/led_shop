<?php 
    ...
    $product_update = (isset($_GET["u"]) ? $_GET["u"] : '');
    ...
    if(!empty($product_update)) {
        ...
        $product = db_product_get_by_id($product_update);

        if(is_submit("edit-product")) {
            ...
            if(!($error)) {
                ...
                $error = db_product_update($data, $product["id"]); 
                  ...
                  <div class="main-sidebar-mobile show">
                    ...
                    <div class="sidebar-content p-0">
                      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item accordion-item">
                          <button type="button" class="nav-link accordion-button collapsed" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                            <i class="ti ti-layout-grid3-alt me-2"></i>
                            Quản lý dịch vụ
                            <i class="ti ti-angle-right float-end mt-2"></i>
                          </button>
                        ...
                        <li class="nav-item">
                          <button type="button" class="nav-link accordion-button collapsed" data-bs-toggle="collapse" data-bs-target="#user" aria-expanded="true" aria-controls="user">
                            <i class="ti ti-user me-2"></i>
                            Quản lý người dùng
                            <i class="ti ti-angle-right float-end mt-2"></i>
                          </button>
                        ...
                        <li class="nav-item">
                          <button type="button" class="nav-link accordion-button collapsed" data-bs-toggle="collapse" data-bs-target="#contact" aria-expanded="true" aria-controls="contact">
                            <i class="ti ti-headphone-alt me-2"></i>
                            Quản lý tin tư vấn
                            <i class="ti ti-angle-right float-end mt-2"></i>
                          </button>
        ...
        <div class="content-wrapper">
          <div class="container-fluid overflow-scroll bg-secondary bg-opacity-10" style="min-height: calc(100vh - 55px)">
            <div class="row py-3 border-bottom">  
                <div class="col-md-6">
                  <h5 class="ms-3">Cập nhật dự án</h5>
                </div>
            </div>

            <div class="row bg-white my-3 mx-1 py-3 px-2 rounded-2">
              <div class="col-md-12">
              <form id="form-edit-product" class="form-login" method="post" action="<?php echo base_url('admin/?m=product&a=edit&u='.$product['name']); ?>" enctype="multipart/form-data">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <div class="form-group-flex">
                            <input type="file" class="form-control border-0" id="thumbnail" name="thumbnail" value="<?=isset($product["thumbnail"]) ? $product["thumbnail"] : '';?>">
                        </div>
                        <div class="row mt-4">
                            <div class="col-md-2 img-grid">
                                <img src="<?= isset($product["thumbnail"]) ? './storage/uploads/' . $product["thumbnail"] : ''?>" alt="" class="w-100">
                            </div>
                        </div>
                        <span class="form-message"></span>
                    </div>
                    <input type="hidden" name="request_name" value="edit-product"/>
