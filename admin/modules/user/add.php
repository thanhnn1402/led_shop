<?php 
    ...
    if(is_submit("add-user")) {
        ...
        if(empty($level)) {
          $error["level"] = "Bạn chưa nhập mật khẩu";
      }
          ...
          <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            <li class="nav-item">
              ...
              <ul class="navbar-nav me-auto mb-2 mb-lg-0 accordion-collapse collapse show" id="user" aria-labelledby="headingOne" data-bs-parent=".nav-item">
                ...
                <li class="nav-item">
                  <a href="<?php echo create_link(base_url('admin'), array('m' => 'user', 'a' => 'add')); ?>" class="nav-link check"><i class="fa-regular fa-circle me-2"></i> Thêm người dùng</a>
                </li>
              </ul>
            </li>
            <li class="nav-item">
        ...
        <div class="content-wrapper">
          <div class="container-fluid overflow-scroll bg-secondary bg-opacity-10" style="min-height: calc(100vh - 55px)">
            <div class="row py-3 border-bottom">  
                <div class="col-md-6">
                  <h5 class="ms-3">Thêm người dùng</h5>
                </div>
            </div>

            <div class="row bg-white my-3 mx-1 py-3 px-2 rounded-2">
              <div class="col-md-12">
                <form id="form-add-user" class="form-login" method="post" action="<?php echo base_url('admin/?m=user&a=add'); ?>" enctype="multipart/form-data">
                    ...
                    <div class="form-group mb-3">
                        <label for="level" class="form-label">Cấp bậc tài khoản</label>
                        <div class="form-group-flex">
                    ...
                    <input type="hidden" name="request_name" value="add-user"/>
    ...
    <script>
        validator({
            ...
            rules: [
                ...
                validator.isRequired('#level', 'Vui lòng nhập trường này'),

            ]
        });

      readFileImg('#form-add-user');
