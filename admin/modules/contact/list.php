          ...
          <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            <li class="nav-item">
              ...
              <ul class="navbar-nav me-auto mb-2 mb-lg-0 accordion-collapse collapse show" id="contact" aria-labelledby="headingOne" data-bs-parent=".nav-item">
                <li class="nav-item">
                  <a href="<?php echo create_link(base_url('admin'), array('m' => 'contact', 'a' => 'list')); ?>" class="nav-link check"><i class="fa-regular fa-circle me-2"></i>Danh sách tin</a>
                </li>
              </ul>
            </li>
        ...
        <div class="content-wrapper">
          <div class="container-fluid overflow-scroll bg-secondary bg-opacity-10" style="min-height: calc(100vh - 55px)">
            <div class="row py-3 border-bottom">  
                <div class="col-md-6">
                  <h5 class="ms-3">Danh sách tin</h5>
                </div>
            </div>

            <div class="row bg-white my-3 mx-1 py-3 px-2 rounded-2 overflow-scroll">
              <div class="col-md-12">
                <table class="table table table-striped display overflow-scroll table-contact" id="table">
                  <thead>
                    <tr>
                        <th>STT</th>
                        <th>Họ tên</th>
                  ...
                  <tbody>
                        ...
                        ?>  
                            <tr>
                              <td class="counter"></td>
                              <td class="text-truncate"><?=$item["fullname"]?></td>
                              <td class="text-truncate"><?=$item["email"]?></td>
                              <td class="text-truncate"><?=$item["phone"]?></td>
                              <td class="text-truncate"><?=$item["address"]?></td>
                              <td>
                                <?=$item["state"] == 1 ? '<span class="text-success">Đã phản hồi</span>': '<span class="text-danger">Chưa phản hồi</span>'?>
                              </td>
                              <td>
                                <a href="<?php echo base_url("admin/?m=contact&a=edit&u=".$item["id"]); ?>" class="btn btn-outline-primary btn-sm"><i class="fa-solid fa-pen-to-square"></i></a>
                                <a href="<?php echo base_url("admin/?m=contact&a=delete&u=".$item["id"]); ?>" class="btn btn-outline-danger btn-sm"><i class="fa-solid fa-trash-can"></i></a>
                              </td>
