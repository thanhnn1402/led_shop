<?php 
    ...
    $user_count = db_user_get_counter();
    $contact_count = db_contact_get_counter();
    $product_count = db_product_get_counter();
    $service_count = db_service_get_counter();
?>
        ...
        <div class="content-wrapper">
          <div class="container-fluid overflow-scroll bg-secondary bg-opacity-10" style="min-height: calc(100vh - 55px)">
            <div class="row py-3 border-bottom">  
                <div class="col-md-6">
                  <h5 class="ms-3">QUẢN LÝ WEBSITE</h5>
                </div>
            </div>
            ...
            <div class="row bg-white my-3 mx-1 py-3 px-2 rounded-2">
              <div class="col-lg-3 col-md-6 col-12 mt-4">
                <div class="card bg-success">
                  <div class="card-body">
                    <h4 class="card-title text-white d-flex justify-content-between">
                      <span>Người dùng</span>
                      <span><i class="ti ti-user"></i></span>
                    </h4>
                    <p class="card-text text-white fs-4"><?=$user_count?></p>
                  </div>
                </div>
              </div>
              ...
              <div class="col-lg-3 col-md-6 col-12 mt-4">
                <div class="card bg-info">
                  <div class="card-body">
                    <h4 class="card-title text-white d-flex justify-content-between">
                      <span>Dịch vụ</span>
                      <span><i class="ti ti-layout-grid2-alt"></i></span>
                    </h4>
                    <p class="card-text text-white fs-4"><?=$service_count?></p>
                  </div>
                </div>
              </div>
                ...
                <div class="card bg-danger">
                  <div class="card-body">
                    <h4 class="card-title text-white d-flex justify-content-between">
                      ...
                      <span><i class="ti ti-headphone-alt"></i></span>
                    </h4>
                    <p class="card-text text-white fs-4"><?=$contact_count?></p>
                  </div>
                </div>
              </div>
              ...
              <div class="col-lg-3 col-md-6 col-12 mt-4">
                <div class="card bg-warning">
                  <div class="card-body">
                    ...
                    <p class="card-text text-white fs-4"><?=$product_count?></p>
                  </div>
                </div>
              </div>
            </div>
