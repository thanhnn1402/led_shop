          ...
          <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            <li class="nav-item accordion-item">
              ...
              <ul class="navbar-nav me-auto mb-2 mb-lg-0 accordion-collapse collapse show" id="collapseOne" aria-labelledby="headingOne" data-bs-parent=".nav-item">
                <li class="nav-item">
                  <a href="<?php echo create_link(base_url('admin'), array('m' => 'service', 'a' => 'list')); ?>" class="nav-link check"><i class="fa-regular fa-circle me-2"></i>Danh sách dịch vụ</a>
                </li>
                <li class="nav-item">
        ...
        <div class="content-wrapper">
          <div class="container-fluid overflow-scroll bg-secondary bg-opacity-10" style="min-height: calc(100vh - 55px)">
            <div class="row py-3 border-bottom">  
                <div class="col-md-6">
                  <h5 class="ms-3">Danh sách dịch vụ</h5>
                </div>
            </div>

            <div class="row bg-white my-3 mx-1 py-3 px-2 rounded-2 overflow-scroll">
              <div class="col-md-12">
                <table class="table table table-striped display overflow-scroll table-service" id="table">
                  <thead>
                    <tr>
                        <th>STT</th>
                        <th>Tên dịch vụ</th>
                  ...
                  <tbody>
                        ...
                        ?>  
                            <tr>
                              ...
                              <td>
                                <a href="<?php echo base_url("admin/?m=service&a=edit&u=".$item["id"]); ?>" class="btn btn-outline-primary btn-sm"><i class="fa-solid fa-pen-to-square"></i></a>
                                <a href="<?php echo base_url("admin/?m=service&a=delete&u=".$item["id"]); ?>" class="btn btn-outline-danger btn-sm"><i class="fa-solid fa-trash-can"></i></a>
                              </td>
